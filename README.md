...
一个面向**辽宁省专升本 2027 年考试（计算机组）**考生的跨平台备考工具，包含 **PC 桌面版（Electron）** 和 **安卓版（WebView）**，一套前端代码双端复用。
...
> **本 App 的内容并不完整，不能作为专升本复习的全部。**

- 知识点和题目只是**部分考点提炼**，覆盖范围有限，**不代表完整考纲**
- 本 App 的定位是**辅助工具**：用于碎片时间巩固、自测和错题回顾
- **正式复习请以教材、老师授课、官方考纲和历年真题为准**
- 分数线、考试日期等数据仅供参考，**以辽宁省招考办官方通知为准**
- 题库中的题目为按考点编写的**练习题**，**不是历年真题**
